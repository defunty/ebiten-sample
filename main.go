...
func (g *Game) Update() error {
	...
	hoge := ebiten.TouchIDs()
	fmt.Printf("tt %s tt", hoge)
	...
	// fmt.Printf(fmt.Sprintf("%T, %v", inpututil.JustPressedTouchIDs, inpututil.JustPressedTouchIDs))
	...
	//fmt.Printf(fmt.Sprintf("%d", len(g.touches)))
